import { Cart, CartItem, Image, Money, Product, ProductVariant } from "../types";
...
import { FourthwallCollection } from "./types";
...
export const reshapeCollection = (fwCollection: FourthwallCollection): Collection => {
  return {
    handle: fwCollection.slug,
    title: fwCollection.name,
    description: fwCollection.description,
    image_url: fwCollection.image?.url || "/assets/images/placeholder.png"
  };
};