            ...
            <ul className="nav">
              ...
              <li className={pathname === "/services" ? "active" : ""}>
                <Link href="/services" onClick={onLinkClick}>
                  <FontAwesomeIcon icon={faList} /> Services
                </Link>
              </li>
              <li className={pathname === "/portfolio" ? "active" : ""}>
                <Link href="/portfolio" onClick={onLinkClick}>
              ...
              <li className={pathname === "/shop" ? "active" : ""}>
                <Link href="/shop" onClick={onLinkClick}>
                  <FontAwesomeIcon icon={faStore} /> Shop
                </Link>
              </li>
              <li className={pathname === "/terms-of-service" ? "active" : ""}>
                <Link href="/terms-of-service" onClick={onLinkClick}>
                  <FontAwesomeIcon icon={faFileAlt} /> User Agreement
                </Link>
              </li>
            </ul>
          </nav>
              ...
              <div className="row">
                ...
                <div className="footer-item">
                  <div className="social-links">
                    <a
                      href="https://www.facebook.com/shdwfanglabs"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <a
                      href="https://instagram.com/shdwfanglabs"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <a
                      href="https://linkedin.com/in/shdwfanglabs"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <a
                      href="https://bsky.app/profile/shdwfanglabs.bsky.social"
                      target="_blank"
                      rel="noreferrer"
                    >
